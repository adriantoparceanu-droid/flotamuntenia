                        ...
                        <div>
                            ...
                            <table class="w-full text-sm">
                                ...
                                <tbody class="divide-y divide-gray-50 dark:divide-gray-700/50">
                                    @forelse($sumarProduse as $denumire => $cantitate)
                                        <tr>
                                ...
                                @if(!empty($sumarProduse))
                                    <tfoot>
                                        <tr class="border-t border-gray-200 dark:border-gray-600">
                                            <td class="pt-2 text-xs text-gray-500 dark:text-gray-400">Total bucăți</td>
                                            <td class="pt-2 text-right font-bold tabular-nums text-gray-800 dark:text-gray-200">{{ array_sum($sumarProduse) }}</td>
                                        </tr>
                                    </tfoot>
                                @endif
                            </table>
